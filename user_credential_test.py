...
class TestUser(unittest.TestCase):
    def setUp(self):
        self.new_user = User(
            'horace', 'achapa', 'horaceachapa425@gmail.com', '0727719206', '1234')

    def test__init__(self):
        self.assertEqual(self.new_user.first_name, 'horace')
        self.assertEqual(self.new_user.last_name, 'achapa')
        self.assertEqual(self.new_user.email, 'horaceachapa425@gmail.com')
    ...
    def test_save_user(self):
        ...
        test_user = User('horace', 'achapa', 'horaceachapa425@gmail.com',
                         '0727719206', '1234')
        test_user.save_user()
...
class TestCredential(unittest.TestCase):
    def setUp(self):
        self.new_credential = Credential(
            'horace', 'twitter', 'horace-muliande', '12345')

    def test__init__(self):
        self.assertEqual(self.new_credential.user_name, 'horace')
        self.assertEqual(self.new_credential.site_name, 'twitter')
        self.assertEqual(self.new_credential.account_name, 'horace-muliande')
...
# Testing credentials
    ...
    def test_save_credentials(self):
        ...
        twitter = Credential('horace', 'twitter', 'horace-muliande', '12345')
